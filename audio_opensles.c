...
#define LOG_TAG "shairport_opensles"
...
static void start(int sample_rate) {
  ALOGI("OpenSLES audio output started at Fs=%d Hz\n", sample_rate);
  createBufferQueueAudioPlayer(sample_rate, 44100);
}
...
static void stop(void) { 
  ALOGI("opensles audio stopped\n"); 
}

static int init(int argc, char **argv) {
  debug(1, "opensles init");
...
//  config.audio_backend_latency_offset = 40000;
  ...
  //Not bad
//  config.audio_backend_latency_offset = 36780;
    config.audio_backend_latency_offset = 33000; //35000 //35500
...
static void help(void) { 
  printf("    OpenSLES audio playback.\n");
}

audio_output audio_opensles = {.name = "opensles",
                            .help = &help,
                            .init = &init,
                            .deinit = &deinit,
                            .start = &start,
